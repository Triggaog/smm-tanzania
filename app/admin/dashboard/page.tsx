...
export default async function Page(){
 const [services,posts,testimonials,team]=await Promise.all([
  db.service.count(),
  db.contentItem.count({where:{type:"post"}}),
  db.contentItem.count({where:{type:"testimonial"}}),
  db.contentItem.count({where:{type:"team"}}),
 ]);
