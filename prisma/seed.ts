...
async function main(){
 ...
 const items=[
  ...
  ["setting","contact-footer","Contact, Social & Footer Settings","Global website details",{email:"info@smmtanzania.com",phone:"+255 756 405 950",location:"Dar es Salaam, Tanzania",whatsapp:"255756405950",instagram:"https://www.instagram.com/smm.tanzania?igsh=MTU3ZmM5NWFqM29tOA==",facebook:"https://facebook.com",linkedin:"https://linkedin.com",footerDescription:"A social media and Meta support agency based in Dar es Salaam, Tanzania.",copyright:"SMM Tanzania"}],
 ...
 for(const [i,x] of items.entries())await db.contentItem.upsert({where:{type_slug:{type:x[0] as string,slug:x[1] as string}},update:x[0]==="setting"?{data:x[4] as object}:{},create:{type:x[0] as string,slug:x[1] as string,title:x[2] as string,summary:x[3] as string,data:x[4] as object,status:ContentStatus.PUBLISHED,displayOrder:i}});
 const settings={contact:{email:"info@smmtanzania.com",phone:"+255 756 405 950",location:"Dar es Salaam, Tanzania"},social:{instagram:"https://www.instagram.com/smm.tanzania?igsh=MTU3ZmM5NWFqM29tOA==",facebook:"https://facebook.com",linkedin:"https://linkedin.com",whatsapp:"255756405950"},footer:{description:"A social media and Meta support agency based in Dar es Salaam, Tanzania.",copyright:"SMM Tanzania"}};for(const [key,value] of Object.entries(settings))await db.siteSetting.upsert({where:{key},update:{value},create:{key,value}})
}
